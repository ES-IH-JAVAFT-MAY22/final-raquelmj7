...
export class EntertainmentComponent implements OnInit {
  ...
  getEntertainment():void {
    this.type=this.route.snapshot.params['type'] as string;
    this.gamesApi.getEntertainment(this.type).subscribe(
      (response:Games[])=>{
        this.entertainmentGames=response;
